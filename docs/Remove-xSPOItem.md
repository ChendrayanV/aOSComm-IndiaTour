...
online version: https://github.com/ChendrayanV/aOSComm-IndiaTour/blob/master/docs/Remove-xSPOItem.md
schema: 2.0.0
---
...
```
Remove-xSPOItem [-Url] <Object> [-Title] <Object> [-Id] <Object> [<CommonParameters>]
```
